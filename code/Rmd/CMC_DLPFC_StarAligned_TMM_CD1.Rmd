...
Normalising COUNTS with a custom design matrix. Here Instituiton, Gender, LibraryBatch, Age\\_of\\_Death, PMI, RIN, RIN2, EV.1, EV.2, EV.3, EV.4, EV.5 are adjusted conditioned on Dx
```{r customNorm, results='asis'}
# Primary variable of interest
postAdjustCovars = c('Dx', 'Institution', 'Gender', 'LibraryBatch', 'Age_of_Death',
