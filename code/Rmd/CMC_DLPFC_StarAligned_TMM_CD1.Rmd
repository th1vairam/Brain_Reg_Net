---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-Feature counts pipeline (DLPFC with TMM normlaisation and Custom Design 1)"
...
knit2synapse::knitToFolderEntity(file = "./CMC_DLPFC_StarAligned_TMM_CD1.Rmd",
                                 parentId ="syn7501880",
                                 entityName = 'DLPFC - STAR Reprocessed - with TMM - Custom Design 1')
```
...
thisFileName <- 'CMC_DLPFC_StarAligned_TMM_CD1.Rmd'
...
```{r dataExplore, fig.width = 14, fig.height = 6}
...
Normalising COUNTS with a custom design matrix. Here Instituiton, Gender, LibraryBatch, Age\\_of\\_Death, PMI, RIN, RIN2, EV.1, EV.2, EV.3, EV.4, EV.5 are adjusted conditioned on Dx.Tissue
```{r customNorm, results='asis'}
# Primary variable of interest
postAdjustCovars = c('Dx.Tissue', 'Institution', 'Gender', 'LibraryBatch', 'Age_of_Death',
                     'PMI', 'RIN', 'RIN2', 'EV.1', 'EV.2', 'EV.3', 'EV.4', 'EV.5');
...
# Code
CODE <- Folder(name = "DLPFC - STAR Reprocessed - with TMM - Custom Design 1", parentId = parentId)
CODE <- synStore(CODE)
