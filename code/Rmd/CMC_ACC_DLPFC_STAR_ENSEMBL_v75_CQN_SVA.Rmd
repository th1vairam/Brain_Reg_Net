...
tmp = svd(RESIDUAL.GENE_EXPRESSION)
...
permuted.var = foreach(i = 1:20, .combine = rbind, .packages = c('dplyr')) %dopar% {
  tmp.residual = t(apply(RESIDUAL.GENE_EXPRESSION, 1, sample, replace = FALSE))
...
SURR.VAR = irwsva.build(CQN.GENE_EXPRESSION$E, MODEL1, MODEL0, n.sv = NUM.SV, B = 30, tol = 1e-20)$sv
