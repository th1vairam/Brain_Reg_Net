---
title: "Covariates analysis of MSBB RNASeq data of region BM 36"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_BM_36_RNASeq.Rmd",
                                 parentId ="syn5570248",
                                 entityName = 'MSBB BM 36 RNASeq')
```
...
thisFileName <- 'MSSM_BM_36_RNASeq.Rmd'
...
METADATA = left_join(METADATA %>%
  ...
  dplyr::filter(BrainRegion == 'BM_36')
...
# Code
CODE <- Folder(name = "MSBB BM 36 RNASeq", parentId = parentId)
CODE <- synStore(CODE)
