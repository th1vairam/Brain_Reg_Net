---
title: "Covariate analysis of MAYO reprocessed counts (with TMM and SVA normalisation)"
...
knit2synapse::knitToFolderEntity(file = "./Mayo_RNASeq_Reprocessed_TMM_SVA.Rmd",
                                 parentId = "syn5570325",
                                 entityName = 'UFL_Mayo_ISB Reprocessed RNASeq TMM SVA')
```
...
thisFileName <- 'Mayo_RNASeq_Reprocessed_TMM_SVA.Rmd'
...
```{r sva}
MODEL0 = DM1$design[,-grep('BrainRegion.Diagnosis',colnames(DM1$design))] # Get null model by removing variable of interest
...
# Code
CODE <- Folder(name = 'UFL_Mayo_ISB Reprocessed RNASeq TMM SVA', parentId = parentId)
...
# Store design matrix
write.table(DM1$design, file = 'MAYO_CBE_TCX_Design.tsv', sep = '\t', row.names=F, quote=F)
