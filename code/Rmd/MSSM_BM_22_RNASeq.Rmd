---
title: "Covariates analysis of MSBB RNASeq data of region BM 22"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_BM_22_RNASeq.Rmd",
                                 parentId ="syn5570248",
                                 entityName = 'MSBB BM 22 RNASeq')
```
...
activityDescription = 'Covariate analysis of MSBB BM 22 RNASeq samples';

thisFileName <- 'MSSM_BM_22_RNASeq.Rmd'
...
METADATA = left_join(METADATA %>%
  ...
  dplyr::filter(BrainRegion == 'BM_22')
...
# Code
CODE <- Folder(name = "MSBB BM 22 RNASeq", parentId = parentId)
CODE <- synStore(CODE)
