---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-HTSeq pipeline (DLPFC with TMM normlaisation)"
...
knit2synapse::knitToFolderEntity(file = "./CMC_DLPFC_StarAligned_TMM.Rmd",
                                 parentId ="syn5569976",
                                 entityName = 'CMC - DLPFC - STAR Reprocessed - with TMM')
```
...
activityDescription = 'Covariate analysis of star aligned CMC reprocessed RNASeq data with TMM normalisation (DLPFC)';

thisFileName <- 'CMC_DLPFC_StarAligned_TMM.Rmd'
...
postAdjustCovars = unique(c(postAdjustCovars, 'Dx'))
...
# Code
CODE <- Folder(name = "CMC - DLPFC - STAR Reprocessed - with TMM", parentId = parentId)
CODE <- synStore(CODE)
