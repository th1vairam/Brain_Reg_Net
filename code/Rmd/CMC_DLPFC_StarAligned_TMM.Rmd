---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-Feature counts pipeline (DLPFC with TMM normlaisation)"
...
To be consistent with DLPFC Nature Neuroscience article we performed a custom adjustment with Dx, RIN, RIN2, Age of Death, PMI, Library Batch, Institution, Gender, EV1, EV2, EV3, EV4, EV5
```{r custom.design}
