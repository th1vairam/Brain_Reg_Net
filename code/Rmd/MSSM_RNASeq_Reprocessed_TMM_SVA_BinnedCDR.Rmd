...
knit2synapse::knitToFolderEntity(file = "./MSSM_RNASeq_Reprocessed_TMM_SVA_BinnedCDR.Rmd",
                                 parentId = "syn5570248",
                                 entityName = 'MSBB Reprocessed RNASeq TMM SVA Binned CDR')
```
...
thisFileName <- 'MSSM_RNASeq_Reprocessed_TMM_SVA_BinnedCDR.Rmd'
...
postAdjustCovars = c('BrodmannArea.Dx', 'batch', 'SEX')
...
```{r sva}
MODEL0 = DM1$design[,-grep('BrodmannArea.Dx',colnames(DM1$design))] # Get null model by removing variable of interest
...
# Code
CODE <- Folder(name = 'MSBB Reprocessed RNASeq TMM SVA Binned CDR', parentId = parentId)
