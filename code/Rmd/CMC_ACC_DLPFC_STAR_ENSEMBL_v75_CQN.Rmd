...
while(length(residualSigCovars$significantCovars)!=0 && loopCount <= 100){
  ...
  RESIDUAL.GENE_EXPRESSION$E.NA = residuals.MArrayLM(ADJUSTED.FIT, CQN.GENE_EXPRESSION$E.NA)
  RESIDUAL.GENE_EXPRESSION$E.zero = RESIDUAL.GENE_EXPRESSION$E.NA
  RESIDUAL.GENE_EXPRESSION$E.zero[is.na(RESIDUAL.GENE_EXPRESSION$E.NA)] = 0
  
  # Residual covariates to choose from
  residCovars <- setdiff(c(FactorCovariates,ContCovariates), c(postAdjustCovars, 'Individual_ID'))
  
  # Find PC of residual gene expression and significant covariates that are highly correlated with PCs
  tmp.expr = RESIDUAL.GENE_EXPRESSION$E.zero
...
# Find principal components of expression to plot
PC <- prcomp(RESIDUAL.GENE_EXPRESSION$E.zero, scale.=T, center = T)
...
tree = hclust(as.dist(t(RESIDUAL.GENE_EXPRESSION$E.zero)))
cols = WGCNA::labels2colors(COVARIATES.tmp);
