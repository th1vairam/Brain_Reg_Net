---
title: "Covariate analysis of MSSM reprocessed counts (with TMM normalisation and covariates adjusted)"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_REPROCESSED_TMM.Rmd",
                                 parentId = "syn7554308",
                                 entityName = 'MSSM Reprocessed RNASeq (Normalised - With out gene length and gc content adjustment)')
```
...
thisFileName <- 'MSSM_REPROCESSED_TMM.Rmd'
...
Initial normalisation usign TMM and dispersion control with voom (with NULL design)
...
NUM.SV = sva::num.sv(VOOM.WEIGHTS$E, MODEL1, method = 'be', seed = 123456, B = 30)

# Estimate surrogate variables
SURR.VAR = sva::sva(VOOM.WEIGHTS$E, MODEL1, MODEL0, n.sv = NUM.SV, B = 30)$sv
...
# Code
CODE <- Folder(name = "MSSM Reprocessed RNASeq (Normalised - With out gene length and gc content adjustment)", parentId = parentId)
