---
title: "Covariate analysis of CMC RNASeq data reprocessed with RSEM-feature counts workflow with GRCh38 (DLPFC with CQN normlaisation)"
...
knit2synapse::createAndKnitToFolderEntity(file = "./CMC_DLPFC_RSEM_GRCh38_CQN_ModSel.Rmd",
                                          parentId ="syn9846623",
                                          folderName = 'DLPFC - RSEM - EXPECTED COUNTS - GRCh38 - CQN - Sparse Model - Kelsey')
```
...
METADATA_QC_DLPFC = downloadFile_version(METADATA_QC_DLPFC_ID, version = 7) %>%
...
# Code
CODE <- Folder(name = "DLPFC - RSEM - EXPECTED COUNTS - GRCh38 - CQN - Sparse Model - Kelsey", parentId = parentId)
CODE <- synStore(CODE)
