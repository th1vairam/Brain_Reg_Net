...
knit2synapse::knitToFolderEntity(file = "./HBCC_DLPFC_STAR_ENSEMBL_v75_CQN_qSVA.Rmd",
                                 parentId ="syn7501880",
                                 entityName = 'HBCC - DLPFC - STAR - FEATURE COUNTS - ENSEMBL v75 - CQN - qSVA')
```
...
qSV_DEG_MAT_ID = 'syn10284941'
ALL_USED_IDs[length(ALL_USED_IDs)+1] = qSV_DEG_MAT_ID
qSV_DEG_MAT = downloadFile(qSV_DEG_MAT_ID)
tmp = t(qSV_DEG_MAT[,-(1)])
...
ContCovariates <- c("Age_of_Death", "PMI", "RIN", "TotalReads", "X5prime_Norm", "Mean_Per_Base_Cov.",
                    ...
                    "PercentMapped", "qSV1", "qSV2", "qSV3", "qSV4")
...
adjust.covars = c('Dx.Tissue', 'Gender', 'RIN', 'IntronicRate', 'qSV1', 'qSV2', 'qSV3', 'qSV4')
...
postAdjustCovars = c('Dx.Tissue.Gender', 'RIN', 'IntronicRate', 'qSV1', 'qSV2', 'qSV3', 'qSV4')
...
all.annotations = list(
  ...
  normalizationType	= 'CQNandQSVA'
)

# Code
CODE <- Folder(name = "HBCC - DLPFC - STAR - FEATURE COUNTS - ENSEMBL v75 - CQN - qSVA", parentId = parentId)
