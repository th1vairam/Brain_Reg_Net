---
title: "Covariate analysis of ROSMAP Reprocessed RNASeq data with TMM"
...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_RNASeq_Reprocessed_TMM.Rmd",
                                 parentId ="syn5570291",
                                 entityName = 'ROSMAP RNASeq Reprocessed Counts TMM (Based on cogdx)')
```
...
# Code
CODE <- Folder(name = "ROSMAP RNASeq Reprocessed Counts TMM (Based on cogdx)", parentId = parentId)
CODE <- synStore(CODE)
