---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-Feature counts pipeline (ACC with TMM normlaisation)"
...
Adding Dx, Institution, Gender, EV1, EV3, EV4 and EV5 to the list of postadjust covariates RIN, RIN2, Age of Death, PMI and EV2
```{r custom.design}
