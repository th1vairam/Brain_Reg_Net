...
write.table(COVARIATES, file = 'MAYO_DLPFC_Covariates.tsv', sep = '\t', row.names=F, quote=F)
COV_OBJ = File('MAYO_DLPFC_Covariates.tsv', name = 'Covariates', parentId = CODE$properties$id)
...
PROCESSED_COUNTS$filteredExprMatrix$counts %>%
  rownameToFirstColumn('ensembl_gene_id') %>%
  write.table(file = 'MAYO_DLPFC_Counts.tsv', sep = '\t', row.names=F, quote=F)
COUNT_OBJ = File('MAYO_DLPFC_Counts.tsv', name = 'Counts (filtered raw)', parentId = CODE$properties$id)
...
CQN.GENE_EXPRESSION$y %>%
  rownameToFirstColumn('ensembl_gene_id') %>%
  write.table(file = 'MAYO_DLPFC_logCPM.tsv', sep = '\t', row.names=F, quote=F)
LCOUNT_OBJ = File('MAYO_DLPFC_logCPM.tsv', name = 'Counts (filtered logCPM)', parentId = CODE$properties$id)
...
CQN.GENE_EXPRESSION$offset %>%
  rownameToFirstColumn('ensembl_gene_id') %>%
  write.table(file = 'MAYO_DLPFC_offset.tsv', sep = '\t', row.names=F, quote=F)
OFFSET_OBJ = File('MAYO_DLPFC_offset.tsv', name = 'Gene length and GC content offset', parentId = CODE$properties$id)
...
MODEL1 %>%
  rownameToFirstColumn('SampleID') %>%
  write.table(file = 'MAYO_DLPFC_Design.tsv', sep = '\t', row.names=F, quote=F)
DM_OBJ = File('MAYO_DLPFC_Design.tsv', name = 'Design Matrix', parentId = CODE$properties$id)
...
SURR.VAR %>%
  rownameToFirstColumn('SampleID') %>%
  write.table(file = 'MAYO_DLPFC_SurVar.tsv', sep = '\t', row.names=F, quote=F)
SURR_OBJ = File('MAYO_DLPFC_SurVar.tsv', name = 'Surrogate Variables', parentId = CODE$properties$id)
...
RESIDUAL.SVA.GENE_EXPRESSION %>%
  rownameToFirstColumn('ensembl_gene_id') %>%
  write.table(file = 'MAYO_DLPFC_eQTLResidualExpression.tsv', sep = '\t', row.names=F, quote=F)
eEXP_OBJ = File('MAYO_DLPFC_eQTLResidualExpression.tsv', 
...
RESIDUAL.NET.GENE_EXPRESSION %>%
  rownameToFirstColumn('ensembl_gene_id') %>%
  write.table(file = 'MAYO_DLPFC_netResidualExpression.tsv', sep = '\t', row.names=F, quote=F)
nEXP_OBJ = File('MAYO_DLPFC_netResidualExpression.tsv', 
...
write.table(DE, file = 'MAYO_DLPFC_DiffExpression.tsv', sep = '\t', row.names=F, quote=F)
DEXP_OBJ = File('MAYO_DLPFC_DiffExpression.tsv', 
