...
METADATA = METADATA %>%
  dplyr::mutate(AgeAtDeath = gsub("_or_above", "", AgeAtDeath),
                Diagnosis = factor(Diagnosis, 
                                   ...
                                   labels = c("AD" = "AD", "Control" = "CONTROL", "Pathologic Aging" = "OTHER", "PSP" = "OTHER")),
...
```{r decompse.normalise.data1.1, fig.height=6, fig.width=10, results='asis'}
# Find principal components of expression to plot
...
SURR.VAR = irwsva.build(CQN.GENE_EXPRESSION$E.zero,
