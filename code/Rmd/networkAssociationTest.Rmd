...
other.ad.pathways = c("alzheimer_disease", "Alzheimer.s.disease_Homo.sapiens_hsa05010", 
                      "Alzheimers.Disease_Homo.sapiens_WP2059",
                      "Alzheimer.disease.amyloid.secretase.pathway_Homo.sapiens_P00003",
...
ggplot(tmp, aes(x = method, y = rnk)) + geom_boxplot() + facet_grid(.~brainRegion) + theme(axis.text.x = element_text(angle=45, hjust = 1)) + coord_flip() + geom_jitter()
...
OBJ2 = File('AssociaitonStatWithApoE4.tsv', name = 'Association with ApoE4', parentId = 'syn10831307')
