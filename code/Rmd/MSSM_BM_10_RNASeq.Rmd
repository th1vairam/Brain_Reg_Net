---
title: "Covariates analysis of MSBB RNASeq data of region BM 10"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_BM_10_RNASeq.Rmd",
                                 parentId ="syn5570248",
                                 entityName = 'MSBB BM 10 RNASeq')
```
...
activityDescription = 'Covariate analysis of MSBB BM 10 RNASeq samples';

thisFileName <- 'MSSM_BM_10_RNASeq.Rmd'
...
METADATA = left_join(METADATA %>%
  ...
  dplyr::filter(BrainRegion == 'BM_10')
...
# Code
CODE <- Folder(name = "MSBB BM 10 RNASeq", parentId = parentId)
CODE <- synStore(CODE)
