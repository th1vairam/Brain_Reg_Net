...
METADATA = METADATA %>%
  dplyr::select(Individual_ID, Institution, Gender, Age_of_Death, PMI__in_hours_, Dx, 
                DLPFC_RNA_report__Library_Batch, DLPFC_RNA_report__Ribozero_Batch, DLPFC_RNA_report__Flowcell_Batch,
  ...
  dplyr::rename(LibraryBatch = DLPFC_RNA_report__Library_Batch, 
...
# Fit contrast
contrast = makeContrasts(contrasts=c("Dx.TissueOther_DLPFC-Dx.TissueControl_DLPFC",
