...
knit2synapse::knitToFolderEntity(file = "./HBCC_DLPFC_STAR_ENSEMBL_v75_CQN_ModSel.Rmd",
                                 parentId ="syn9846623",
                                 entityName = 'HBCC - DLPFC - STAR - FEATURE COUNTS - ENSEMBL v75 - CQN (Model Selection)')
```
...
# Code
CODE <- synapseClient::Folder(name = "HBCC - DLPFC - STAR - FEATURE COUNTS - ENSEMBL v75 - CQN (Model Selection)", 
                              parentId = parentId)
synapseClient::annotations(CODE) = all.annotations
