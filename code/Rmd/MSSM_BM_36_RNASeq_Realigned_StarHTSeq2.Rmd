---
title: "Covariates analysis of MSBB RNASeq data of region BM 36 (realigned from FASTQ extracted source BAM in minerva with STAR-HTSeq)"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_BM_36_RNASeq_Realigned_StarHTSeq2.Rmd",
                                 parentId ="syn5570248",
                                 entityName = 'MSBB BM 36 RNASeq RealignedFromSource BAM Picard StarHTSeq')
```
...
thisFileName <- 'MSSM_BM_36_RNASeq_Realigned_StarHTSeq2.Rmd'
...
# Code
CODE <- Folder(name = "MSBB BM 36 RNASeq RealignedFromSource BAM Picard StarHTSeq", parentId = parentId)
CODE <- synStore(CODE)
...
# Store logcpm values
write.table(VOOM.ADJUSTED.GENE_EXPRESSION$E, file = 'logCPM.tsv', sep = '\t', row.names=F, quote=F)
...
|  logCPM                   |  `r exp1_obj$properties$id`     |
