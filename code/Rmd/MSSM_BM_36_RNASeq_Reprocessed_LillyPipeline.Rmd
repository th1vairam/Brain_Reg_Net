...
knit2synapse::knitToFolderEntity(file = "./MSSM_BM_36_RNASeq_Reprocessed_LillyPipeline.Rmd",
                                 parentId ="syn5570248",
                                 entityName = 'MSBB BM 36 RNASeq Reprocessed LillyPipeline')
```
...
thisFileName <- 'MSSM_BM_36_RNASeq_Reprocessed_LillyPipeline.Rmd'
...
METADATA = left_join(METADATA_TECHNICAL %>%
  ...
  unique %>%
  filter(BrainRegion == 'BM_36', !(SampleID %in% c('hB_RNA_8565', 'hB_RNA_4919', 'hB_RNA_9005')))
...
# Code
CODE <- Folder(name = 'MSBB BM 36 RNASeq Reprocessed LillyPipeline', parentId = parentId)
CODE <- synStore(CODE)
