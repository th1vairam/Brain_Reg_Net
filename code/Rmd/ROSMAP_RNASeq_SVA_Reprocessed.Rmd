...
SURR.VAR = sva(VOOM.ADJUSTED.GENE_EXPRESSION$E, MODEL1, MODEL0, method = "irw", n.sv = NUM.SV, B = 20)$sv
...
# Code
CODE <- Folder(name = "ROSMAP RNASeq Reprocessed Counts (Based on cogdx)", parentId = parentId)
CODE <- synStore(CODE)
