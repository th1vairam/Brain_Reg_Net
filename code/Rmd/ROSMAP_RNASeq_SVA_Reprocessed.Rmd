...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_RNASeq_SVA_Reprocessed.Rmd",
                                 parentId ="syn5570291",
                                 entityName = 'ROSMAP RNASeq Reprocessed Counts (Based on cogdx with SVA)')
```
...
SURR.VAR = sva(VOOM.ADJUSTED.GENE_EXPRESSION$E, MODEL1, MODEL0, method = "two-step", n.sv = NUM.SV, B = 30)$sv
...
# Code
CODE <- Folder(name = "ROSMAP RNASeq Reprocessed Counts (Based on cogdx with SVA)", parentId = parentId)
CODE <- synStore(CODE)
