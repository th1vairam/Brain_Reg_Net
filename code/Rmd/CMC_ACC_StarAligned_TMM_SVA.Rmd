...
knit2synapse::knitToFolderEntity(file = "./CMC_ACC_StarAligned_TMM.Rmd",
                                 parentId ="syn5569976",
                                 entityName = 'ACC - STAR Reprocessed - with TMM and SVA')
```
...
thisFileName <- 'CMC_ACC_StarAligned_TMM_SVA.Rmd'
...
Since many covariates are correlated, re-normalising COUNTS with a custom design matrix. Here "Dx" is chosen as the primary variable of interest
```{r custom.norm}
# Primary variable of interest
postAdjustCovars = c('Dx', 'RIN', 'RIN2', 'Age_of_Death', 'PMI', 'LibraryBatch')
...
# Code
CODE <- Folder(name = "ACC - STAR Reprocessed - with TMM and SVA", parentId = parentId)
CODE <- synStore(CODE)
