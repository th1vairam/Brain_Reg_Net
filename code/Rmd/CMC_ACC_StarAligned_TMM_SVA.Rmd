---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-Feature counts pipeline (ACC with TMM and SVA normlaisation)"
...
knit2synapse::knitToFolderEntity(file = "./CMC_ACC_StarAligned_TMM_SVA.Rmd",
                                 parentId ="syn5569976",
...
activityDescription = 'Covariate analysis of star aligned CMC reprocessed RNASeq data with TMM and SVA normalisation (ACC)';
...
To be consistent with ACC Nature Neuroscience article we performed a custom adjustment with Dx, RIN, RIN2, Age of Death, PMI, Library Batch, Institution, Gender
```{r custom.design}
