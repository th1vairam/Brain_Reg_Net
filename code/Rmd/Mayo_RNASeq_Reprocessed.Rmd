...
```
Following samples were considered outliers and removed based on PCA and/or eucledian distance: `r paste(c("11386_CER","1923_CER", "11311_CER", "11477_CER", "11408_TCX", "11294_TCX", "11396_TCX"), collapse = ',')`
```{r preprocess.data1}
...
Since there is a strong association of case control status with Source and flowcell information we are manually including them. Also, to be consistent with other brain banks we are including AgeAtDeath as a covariate.
```{r manual.adjusted.voom.normalisation, results='asis', echo=FALSE}
postAdjustCovars = c(postAdjustCovars, c('Source','FLOWCELL','AgeAtDeath')) %>% unique
randomCovariates = 'Donor_ID'
