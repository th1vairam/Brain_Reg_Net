...
# Fit contrast
contrast = makeContrasts(contrasts = c("BrainRegionFP", "BrainRegionIFG", "BrainRegionPHG", "BrainRegionSTG"),
...
for (region in c('FP', 'STG', 'PHG', 'IFG')){
  tmp = combn(paste0('BrainRegion.Diagnosis', region, '.', c('OTHER','AD','CONTROL')),2)
