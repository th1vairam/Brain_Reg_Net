...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_RNASeq_Reprocessed.Rmd",
                                 parentId ="syn5570291",
                                 entityName = 'ROSMAP RNASeq Reprocessed Counts (Based on cogdx)')
```
...
thisFileName <- 'ROSMAP_RNASeq_Reprocessed.Rmd'
