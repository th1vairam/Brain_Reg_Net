...
```
Following five samples were considered outliers and removed 742\_CER, 11386\_CER, 11311\_CER, 1923\_CER, 11477\_CER
```{r preprocess.data1}
...
```{r calculate.residuals, include=FALSE, results = 'asis'}
# Residuals after normalisation
...
DE = topTable(FIT.CONTR, coef=1, number = dim(VOOM.ADJUSTED.GENE_EXPRESSION$E)[1])
DE = rownameToFirstColumn(DE, 'ensembl_gene_id') %>%
