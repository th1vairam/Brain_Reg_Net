---
title: "Covariate analysis of ROSMAP reprocessed counts (with TMM and SVA normalisation)"
...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_RNASeq_Reprocessed_TMM_SVA.Rmd",
                                 parentId = "syn5570291",
                                 entityName = 'ROSMAP Reprocessed RNASeq TMM SVA (Based on cogdx)')
```
...
thisFileName <- 'ROSMAP_RNASeq_Reprocessed_TMM_SVA.Rmd'
...
# Code
CODE <- Folder(name = "ROSMAP Reprocessed RNASeq TMM SVA (Based on cogdx)", parentId = parentId)
