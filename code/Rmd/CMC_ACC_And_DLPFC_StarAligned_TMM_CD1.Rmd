...
Normalising COUNTS with a custom design matrix. Here Instituiton, Gender, LibraryBatch, Age\\_of\\_Death, PMI, RIN, RIN2, EV.1, EV.2, EV.3, EV.4, EV.5 are adjusted conditioned on Dx.Tissue with Individual\\_ID as random effects.
```{r iterativeNorm, results='asis'}
# Primary variable of interest
postAdjustCovars = c('Dx.Tissue', 'Institution', 'Gender', 'LibraryBatch', 'Age\\_of\\_Death',
