---
title: "Covariate analysis of MSSM reprocessed counts (with TMM and SVA normalisation)"
...
knit2synapse::knitToFolderEntity(file = "./MSSM_RNASeq_Reprocessed_TMM_SVA.Rmd",
                                 parentId = "syn5570248",
                                 entityName = 'MSBB Reprocessed RNASeq TMM SVA')
```
...
thisFileName <- 'MSSM_RNASeq_Reprocessed_TMM_SVA.Rmd'
...
Since many covariates are correlated, re-normalising COVARIATES with a custom design matrix (see syn8049649 for details)
```{r iterative.adjusted.voom.normalisation, results='asis'}
postAdjustCovars = c('BrodmannArea.CDR', 'batch', 'SEX', 'RIN', 'rRNA.rate', 'PMI', 'AOD')
...
```{r sva}
MODEL0 = DM1$design[,-grep('BrodmannArea.CDR',colnames(DM1$design))] # Get null model by removing variable of interest
...
# Code
CODE <- Folder(name = 'MSBB Reprocessed RNASeq TMM SVA', parentId = parentId)
