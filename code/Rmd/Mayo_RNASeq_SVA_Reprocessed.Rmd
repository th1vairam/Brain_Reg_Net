...
num.sv2 = num.sv(EXPR$filteredExprMatrix$COUNT, MODEL1, method = 'be', seed = 123456)
NUM.SV = min(num.sv1, num.sv2)

SURR.VAR = svaseq(EXPR$filteredExprMatrix$counts, MODEL1, MODEL0, n.sv = NUM.SV, method = "two-step", B = 30)$sv
