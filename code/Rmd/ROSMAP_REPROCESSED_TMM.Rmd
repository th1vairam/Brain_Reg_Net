---
title: "Covariate analysis of ROSMAP reprocessed counts (with TMM normalisation and covariates adjusted)"
...
knit2synapse::knitToFolderEntity(file = "./ROSMAP_REPROCESSED_TMM.Rmd",
                                 parentId = "syn8403743",
                                 entityName = 'ROSMAP Reprocessed RNASeq (Normalised - With out gene length and gc content adjustment)')
```
...
thisFileName <- 'ROSMAP_REPROCESSED_TMM.Rmd'
...
```
### CPM Normalisation
Preprocess counts matrix using TMM normalisation
...
2. Primary variable of interest BrainRegion.Diagnosis is excluded from the pool of available covariates for selection
...
# Code
CODE <- Folder(name = "ROSMAP Reprocessed RNASeq (Normalised - With out gene length and gc content adjustment)", parentId = parentId)
