---
title: "Covariate analysis of HBCC RNASeq data reprocessed with STAR-feature counts workflow with Ensembl v75 (DLPFC with CQN and SVA normlaisation)"
...
```{r detect.outliers, fig.height=5, fig.width=5, results='asis', cache = FALSE}
...
### Sample clustering
```{r decompse.normalise.data, fig.height=6, fig.width=8, results='asis', cache=FALSE}
# Find principal components of expression to plot
tmp = CQN.GENE_EXPRESSION$E
tmp[is.na(tmp)] = 0
