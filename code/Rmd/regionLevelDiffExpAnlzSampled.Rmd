---
title: "Brain region specific differential expression analysis (all 7 regions/one region at a time/balanced)"
...
knit2synapse::knitToFolderEntity(file = "./regionLevelDiffExpAnlzSampled.Rmd", 
                                 parentId ="syn9622393",
                                 entityName = "Differential Expression Analysis (per brain region - balanced)")
```
...
thisFileName <- 'regionLevelDiffExpAnlzSampled.Rmd'
...
CODE = Folder(name = 'Differential Expression Analysis (per brain region - balanced)', parentId = parentId)
CODE = synStore(CODE)
