---
title: "Differential expression analysis of reprocessed AMPAD RNASeq data (All 7 brain regions with CQN normlaisation and PCA
...
primaryVariable = c('BrainRegion.Diagnosis');
notEstimable = c('BrainRegion','Diagnosis','BrainRegion.ApoE')
postAdjustCovars = c()

# Assign residual covariates
residualCovars = setdiff(preAdjustedSigCovars$significantCovars, 
                         c(postAdjustCovars, primaryVariable, notEstimable, 'individualIdentifier'))
...
while(length(residualSigCovars$significantCovars)!=0 && loopCount <= 20){
  ...
  residCovars <- setdiff(c(FactorCovariates,ContCovariates),
                         c(postAdjustCovars, primaryVariable, 'COVARIATES$individualIdentifier', notEstimable))
  ...
  residCovars = setdiff(residualSigCovars$significantCovars, c(postAdjustCovars, primaryVariable,
                                                               'individualIdentifier', notEstimable))
