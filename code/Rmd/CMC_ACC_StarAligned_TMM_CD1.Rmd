---
title: "Covariate analysis of CMC RNASeq data reprocessed with Star-Feature counts pipeline (ACC with TMM normlaisation and Custom Design 1)"
...
knit2synapse::knitToFolderEntity(file = "./CMC_ACC_StarAligned_TMM_CD1.Rmd",
                                 parentId ="syn7501880",
                                 entityName = 'ACC - STAR Reprocessed - with TMM - Custom Design 1')
```
...
thisFileName <- 'CMC_ACC_StarAligned_TMM_CD1.Rmd'
...
# Code
CODE <- Folder(name = "ACC - STAR Reprocessed - with TMM - Custom Design 1", parentId = parentId)
CODE <- synStore(CODE)
