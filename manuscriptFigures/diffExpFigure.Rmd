...
```{r syn.store}
# Get github commit
thisRepo <- getRepo(repository = "th1vairam/Brain_Reg_Network", ref="branch", refName='AMPAD_manuscript')
thisFile <- getPermlink(repository = thisRepo, repositoryPath=paste0('manuscriptFigures/',thisFileName))
...
# wikiPg = WikiPage(owner = obj, title = 'Figure1')
